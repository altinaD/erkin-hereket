        ...
        <form className={styles['form']}>
            <div className="w-[100%] flex flex-row gap-[20px]">
                <div className="w-[50%] nowrap mb-[20px]">
                    ...
                    <input placeholder="Jon" className={`${styles['small-input']} font-[RidleyGroteskRegular, GeistVariableVF] placeholder-[#FFFFFF54] bg-[#E45A31] py-[16px] px-[20px]`} type="text" />
                </div>
                <div className="w-[50%] nowrap mb-[20px]">
                    <label className="font-[RidleyGroteskBold, GeistVariableVF] mb-[5px] text-[#FFFFFF] text-[14px] font-[700]">{lastName}</label>
                    <input placeholder="Doe" className={`${styles['small-input']} font-[RidleyGroteskRegular, GeistVariableVF] placeholder-[#FFFFFF54] bg-[#E45A31] py-[16px] px-[20px]`} type="text" />
                </div>
            </div>
            <div className="flex flex-col w-[100%] mb-[20px]">
                ...
                <input placeholder="example@mail.com" className=" font-[RidleyGroteskRegular, GeistVariableVF] placeholder-[#FFFFFF54] bg-[#E45A31] py-[16px] px-[20px]" type="text" />
            </div>
            <div className="flex flex-col w-[100%]">
                <label className="font-[RidleyGroteskBold, GeistVariableVF] mb-[5px] text-[#FFFFFF] text-[14px] font-[700]">{message}</label>
                <textarea placeholder="Your message" className="h-[160px] resize-none font-[RidleyGroteskRegular, GeistVariableVF] placeholder-[#FFFFFF54] bg-[#E45A31] py-[16px] px-[20px]" name="" id=""></textarea>
            </div>
            <div className="flex justify-between items-baseline mb-[40px] max-xs:flex-col max-xs:mb-[60px]">
                ...
                <div className="max-xs:mt-[20px] max-xs:mb-[60px] max-xs:mx-auto">
                    <button onClick={submitForm} className="w-fit mt-[20px] bg-[#D44217] text-[#FFFFFF] flex flex-row items-center rounded-[100px]  py-[8px] pl-[30px] pr-[8px]">
                        <span className="text-[16px] font-[700] font-[AkzidenzGroteskBoldExtended, GeistVariableVF]">{footer("submit")}</span>
