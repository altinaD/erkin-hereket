    ...
    return (
        ...
        <form onSubmit={handleSubmit} className={styles['form']}>
            ...
            <div className="flex flex-col w-[100%] mb-[20px]">
                ...
                <input  onChange={(e) => setFormData((prev) => ({ ...prev, email: e.target.value }))}  value={formData.email} placeholder="example@mail.com" className=" font-[GeistVariableVF] font-[400] text-[14px] placeholder-[#FFFFFF54] bg-[#E45A31] py-[16px] px-[20px]" type="text" />
            </div>
            <div className="flex flex-col w-[100%]">
                <label className="font-[GeistVariableVF] ml-[10px] mb-[5px] text-[#FFFFFF] text-[14px] font-[800]">{message}</label>
                <textarea  onChange={(e) => setFormData((prev) => ({ ...prev, message: e.target.value }))}  value={formData.message} placeholder="Your message" className="h-[160px] resize-none font-[GeistVariableVF] font-[400] text-[14px] placeholder-[#FFFFFF54] bg-[#E45A31] py-[16px] px-[20px]" name="" id=""></textarea>
            </div>
