        ...
        <form onSubmit={handleSubmit} className={styles['form']}>
            <div className="w-[100%] flex flex-row gap-[20px] max-xs:flex-col max-xs:gap-[0]">
                <div className="w-[50%] max-xs:w-[100%] flex flex-col nowrap mb-[20px]">
                    ...
                    <input onChange={(e) => setFormData((prev) => ({ ...prev, name: e.target.value }))} placeholder={placeholders("name")} value={formData.name} className={`${styles['small-input']} font-[GeistVariableVF] font-[400] text-[14px] placeholder-[#FFFFFF54] bg-[#E45A31] py-[16px] px-[20px]`} type="text" />
                </div>
                <div className="w-[50%] max-xs:w-[100%] flex flex-col nowrap mb-[20px]">
                    <label className="font-[GeistVariableVF] ml-[10px] mb-[5px] text-[#FFFFFF] text-[14px] font-[800]">{lastName}</label>
                    <input onChange={(e) => setFormData((prev) => ({ ...prev, lastName: e.target.value }))} value={formData.lastName} placeholder={placeholders("lastName")} className={`${styles['small-input']} font-[GeistVariableVF] font-[400] text-[14px] placeholder-[#FFFFFF54] bg-[#E45A31] py-[16px] px-[20px]`} type="text" />
                </div>
            </div>
            <div className="flex flex-col w-[100%] mb-[20px]">
                <label className="font-[GeistVariableVF] ml-[10px] mb-[5px] text-[#FFFFFF] text-[14px] font-[800]">{email}</label>
                <input onChange={(e) => setFormData((prev) => ({ ...prev, email: e.target.value }))} value={formData.email} placeholder={placeholders("mail")} className=" font-[GeistVariableVF] font-[400] text-[14px] placeholder-[#FFFFFF54] bg-[#E45A31] py-[16px] px-[20px]" type="text" />
            </div>
            <div className="flex flex-col w-[100%]">
                <label className="font-[GeistVariableVF] ml-[10px] mb-[5px] text-[#FFFFFF] text-[14px] font-[800]">{message}</label>
                <textarea onChange={(e) => setFormData((prev) => ({ ...prev, message: e.target.value }))} value={formData.message} placeholder={placeholders("message")} className="h-[160px] resize-none font-[GeistVariableVF] font-[400] text-[14px] placeholder-[#FFFFFF54] bg-[#E45A31] py-[16px] px-[20px]" name="" id=""></textarea>
            </div>
