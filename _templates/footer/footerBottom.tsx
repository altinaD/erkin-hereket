    ...
    return (
        <div className="bg-[#252525] min-h-[20vh] relative overflow-hidden">
            <div className="space py-[80px] flex justify-between items-center ">
                ...
                <span className="font-[GeistVariableVF] absolute bottom-0 left-[50%] translate-x-[-50%] text-center w-[100%] mx-auto mb-[10px] text-[#6C757D] text-[14px] font-[500]">{t("copyright")}</span>
