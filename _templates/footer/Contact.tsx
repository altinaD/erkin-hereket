        ...
        <div className="w-[100%]" >
            <div className="space">
                <div className={`${styles['black']} ${styles['footer-top-content']}`}>
                    <div>
                        <h1 className="text-[46px] text-[#252525] uppercase font-[900] w-[80%] font-[GeistVariableVF] max-xs:text-[26px]">{home("heroTitle")}</h1>
                        <div className={styles["contact-boxes"]}>
                            <div className={` ${styles['address-box']}`}>
                                ...
                                <span className="font-[400] text-[14px] font-[RidleyGroteskRegular, GeistVariableVF]" >{footer("address")}</span>
                            </div>
