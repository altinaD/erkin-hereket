            ...
            <div className="space">
                ...
                <div className={`${styles['black']} ${styles['footer-top-content']}`}>
                    <div>
                        ...
                        <div className={styles["contact-boxes"]}>
                            <div className={` ${styles['address-box']}`}>
                                <span className="font-[700] text-[14px] font-[GeistVariableVF]">{contacts[0]}:</span>
                                <span className="font-[400] text-[14px] font-[RidleyGroteskRegular, GeistVariableVF] overflow-clip" >{footer("address")}</span>
                            </div>
                            <div className={styles['small-boxes']}>
                                <div className={styles['box']}>
                                    <span className="font-[700] text-[14px] font-[GeistVariableVF]">{contacts[1]}:</span>
                                    <span className="font-[400] text-[14px] font-[GeistVariableVF] overflow-clip whitespace-nowrap" >+993 64 64 66 79</span>
                                </div>
                                <div className={styles['box']}>
                                    <span className="font-[700] text-[14px] font-[GeistVariableVF]">{contacts[2]}:</span>
                                    <span className="font-[400] text-[14px] font-[GeistVariableVF] overflow-clip whitespace-nowrap">erkinhereket@gmail.com</span>
                                </div>
                                <div className={styles['box']}>
                                    <span className="font-[700] text-[14px] font-[GeistVariableVF]">{contacts[3]}:</span>
                                    <span className="font-[400] text-[14px] font-[GeistVariableVF] overflow-clip whitespace-nowrap">www.erkinhereket.com.tm</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form className={styles['form']} onSubmit={handleSubmit}>
                        <div className="w-[100%] flex flex-row max-xs:flex-col gap-[20px] max-xs:gap-0">
                            <div className="w-[50%] max-xs:w-[100%] nowrap mb-[20px] flex flex-col">
                                <label className="font-[GeistVariableVF] font-[800] mb-[5px] text-[#252525] text-[14px]">{contact[0]}</label>
                                <input onChange={(e) => setFormData((prev) => ({ ...prev, name: e.target.value }))} placeholder={placeholders("name")} value={formData.name} className={`${styles['small-input']} font-[400] font-[GeistVariableVF] placeholder-[#30303054] border-[#C8C8C8] border-[0.5px] bg-[#F0F0F0] py-[16px] px-[20px]`} type="text" />
                            </div>
                            <div className="w-[50%] max-xs:w-[100%] nowrap mb-[20px] flex flex-col">
                                <label className="font-[GeistVariableVF] font-[800] mb-[5px] text-[#252525] text-[14px]">{contact[1]}</label>
                                <input onChange={(e) => setFormData((prev) => ({ ...prev, lastName: e.target.value }))} placeholder={placeholders("lastName")} value={formData.lastName} className={`${styles['small-input']} font-[400]  font-[GeistVariableVF] placeholder-[#30303054] border-[#C8C8C8] border-[0.5px] bg-[#F0F0F0] py-[16px] px-[20px]`} type="text" />
                            </div>
                        </div>
                        <div className="flex flex-col w-[100%] mb-[20px]">
                            <label className="font-[GeistVariableVF] font-[800] mb-[5px] text-[#252525] text-[14px]">{contact[2]}</label>
                            <input onChange={(e) => setFormData((prev) => ({ ...prev, email: e.target.value }))} placeholder={placeholders("mail")} value={formData.email} className="font-[400]  font-[GeistVariableVF] placeholder-[#30303054] border-[#C8C8C8] border-[0.5px] bg-[#F0F0F0] py-[16px] px-[20px]" type="text" />
                        </div>
                        <div className="flex flex-col w-[100%]">
                            <label className="font-[GeistVariableVF] font-[800] mb-[5px] text-[#252525] text-[14px]">{contact[3]}</label>
                            <textarea onChange={(e) => setFormData((prev) => ({ ...prev, message: e.target.value }))} placeholder={placeholders("message")} value={formData.message} className="h-[160px] resize-none  font-[400] font-[GeistVariableVF] placeholder-[#30303054] border-[#C8C8C8] border-[0.5px] bg-[#F0F0F0] py-[16px] px-[20px]" name="" id=""></textarea>
                        </div>
                        <div className="flex justify-between items-baseline mb-[40px] max-xs:flex-col max-xs:mb-[60px]">
                            ...
                            <div className="max-xs:mt-[20px] max-xs:mb-[60px] max-3xl:absolute max-3xl:left-[50%] max-3xl:translate-x-[-50%]" >
                                <button disabled={loading} className="group transition-bg duration-300 ease-in-out w-fit mt-[20px] bg-[#D44217] hover:bg-[#E35930] text-[#FFFFFF] flex flex-row items-center rounded-[100px] py-[8px] pl-[30px] pr-[8px]">
                                    <span className="text-[16px] font-[800] font-[GeistVariableVF]">{loading ? footer("loading") : footer("submit")}</span>
