...
export default function SubmitBtn({caption, loading}: btnType){
    return (
        <button onClick={} disabled={loading} className="w-fit mt-[20px] bg-[#D44217] text-[#FFFFFF] flex flex-row items-center rounded-[100px] py-[8px] pl-[30px] pr-[8px]">
