            ...
            <div className={`pt-[100px] max-xs:pt-[80px] relative ${styles['home-container']}`}>
                ...
                <Services />
                 <div className="pt-[24px] flex justify-center max-2xl:mt-[40px] max-2xl:mb-[60px] z-2">
                    <Link href="/services" className="font-[RidleyGroteskBold, GeistVariableVF] relative font-[700]  text-[16px] uppercase py-[21px] px-[30px] boreder-[#9E9FA0] border-[1px] rounded-[100px]">Learn more</Link>
                </div>
            </div>
        </div>
                    ...
                    <div className="w-[30%] max-2xl:w-[100%] max-2xl:order-2">
                        {(projects as projectType[]).map((project: projectType, ndx: number) => (
                           <div className="mb-[60px] max-xs:mb-[40px]" key={ndx}>
                                <h1 className="text-[26px] font-[AkzidenzGroteskBoldExtended, GeistVariableVF] mb-[20px] max-xs:text-[20px]">{project.title}</h1>
