                ...
                {(services as ServiceType[]).map((service: ServiceType, ndx: number) => (
                    <div className="change-order mb-[120px] max-xs:mb-[40px] relative" key={ndx}>
                        ...
                        <div className="ml-[66px] max-2xl:ml-[0]">
                            ...
                            <h1 className=" text-[#FFFFFF] text-[28px] font-[900] font-[GeistVariableVF] py-[18px] px-[20px] max-xs:hidden" style={{background: 'linear-gradient(90deg, #D44217 0%, #6E220C 100%)'}}>{service.title}</h1>
                            <div className="grid grid-cols-[4fr_1fr_6fr] max-2xl:grid-cols-[1fr]"> 
                                ...
                                <p className="max-2xl:w-[100%] mt-[42px] max-2xl:mt-[20px] font-[GeistVariableVF] font-medium text-[18px] max-xs:text-[16px] order-text">{service.desc}</p>
